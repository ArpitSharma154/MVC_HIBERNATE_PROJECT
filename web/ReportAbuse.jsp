...
<%@taglib prefix="s"  uri = "/struts-tags" %>
    ...
    <body>
       ...
       <s:div id="center" >
  <s:form action="saveReport"  method="post" cssStyle="color=#ffccc" enctype="multipart/form-data" >
                 <table  style="background-color:#ccccff ; font-size:20px; margin-left:500px;margin-top: 50px "border="1" > 
                <s:iterator value ="list" >
                    ...
                    <td><input type="text"readonly="true" name="post_id" value="<s:property value="post_id"></s:property>" style="background:#ccccff "/>
                     ...
                     <tr>  
                         <td><s:textarea  label="Reason" name="reason" cols="20" rows="8" cssStyle="position:relative" /></td>
                     </tr>
                                        
                      <tr>
                           <td><s:submit name="submit" value="Submit Report" align="center" cssStyle="position:relative"/></td>
