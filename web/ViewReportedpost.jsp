    ...
    <body>
            <header  class="navbar-fixed-top" style=" background-color : rgb(0, 199, 252);">
                <div class="container">
                    ...
                    <nav class="collapse navigation navbar-collapse navbar-right" role="navigation">
                     ...
                     <a href="ContentCategorywise.jsp">&nbsp&nbsp&nbsp search categorywise </a>
                      
                     <a href="ContentDatewise.jsp">&nbsp&nbsp search  datewise </a>
                     
                     <s:url action = "viewReport" id = "vr">
                         <s:param name = "" value = ""> </s:param>
                      </s:url>    
                      <s:a href = "%{vr}">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp View Reports</s:a>
        ...
        <section id="portfolio" style="background-color:#fcfeff">
            ...
            <s:div id = "center" >
               ...
               <p style = "margin-left:350px;font-size: 40px;color: black; ">
                View Reports
               </p>               
                    
               <table style="margin-left:200px; margin-right: 100px; background-color:#ccccff; font-size:20px;" border="1" cellspacing="0" cellpadding="10">
            ...
            <s:iterator value ="report" >          
                  <tr>
                      ...
                      <td><s:property value="rport_id"/></td>  
                      <td><s:property value="date"/></td>                       
                       <td><s:property value ="data_table.post_id"/></td>                      
                       <td><s:property value ="reason"/></td>                      
                       
                       <td> <s:url action = "Viewreportpost" id = "rpv">
                            
                          <s:param name = "data_table.post_id" value = "data_table.post_id"> </s:param>
                            
                       </s:url>    
                        <s:a href = "%{rpv}">View</s:a>
                        </td>
                  </tr>
