...
<%@taglib prefix="s"  uri = "/struts-tags" %>
    ...
    <body>
        ...
        Home Slider
        ==================================== -->
        <section id="portfolio" style="background-color:whitesmoke">
            <br>
            <h2 style="margin-left:50px" >welcome  ,   <s:property value="#session.username"></s:property></h2>
       
             
             <s:label    cssStyle="margin-left:500px;font-size:22px;" value="ADD POST"/>
             <br><br> 
             <s:form action="SavePost" enctype="multipart/form-data" method="post" >
               
                  <table  style="background-color:#ccccff ;color: black; font-size:20px; margin-left: 300px;" border="1" > 
                 
                      <tr>  <td>User id</td>
                           <td><s:property value="#session.userid"></s:property></td>
                     </tr>
                      
                      <tr> 
                           <td><s:file name="myFile" label="Select Image" /></td>
                     </tr>
                 ...
                 list="{'Select Issue','Garbage','Stray Animal','Road','Electricity','Corruption'}" ></s:select></td>
                     ...
                     <tr>  
                      ...
                      <tr>  
                         <td> <s:textarea label="Discription" name="content" cols="20" rows="10" cssStyle="position:relative" /></td>
                     </tr>
                      <tr>  
                         <td> <s:textarea label="location" name="location" cols="20" rows="5" cssStyle="position:relative" /></td>
                     </tr>
                                        
                      <tr>
                           <td><s:submit name="submit" value="Add Post" align="center" cssStyle="position:relative"/></td>
