...
<%@taglib prefix="s"  uri = "/struts-tags" %>
    ...
    <body>
        ...
        <section id="portfolio" style="background-color:#fcfeff">
            <br><br><br>
            <h2 style="margin-left:50px" >welcome  ,  Admin</h2>
         
<s:div id = "center">
               
                
                <b><pre  style = "margin-left:200px;font-size: 18px;color:black; ">
               These all are registered User.
                </pre></b>         
                
                
                <table  style="margin-left:420px;background-color:#ccccff; font-size:20px;" border="1" cellspacing="0" cellpadding="10">
                   ...
                   <s:iterator value = "userlist">
                    ...
                    <td>
                      <s:property value = "user_id"></s:property>
                    </td>
                    
                    <td>
                       <s:url action = "viewProfile" id = "vu">
                            
                          <s:param name = "user_id" value = "user_id"> </s:param>
                            
                       </s:url>    
                        <s:a href = "%{vu}">View</s:a>
 
                    </td>
                    
                    <td>
                       <s:url action = "deleteUser" id = "du">
                            
                          <s:param name = "user_id" value = "user_id"> </s:param>
                            
                       </s:url>    
                       <s:a href = "%{du}">Delete</s:a>
