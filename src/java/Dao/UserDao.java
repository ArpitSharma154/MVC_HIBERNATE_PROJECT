...
public class UserDao
{
       ...
       Session sess = sf.openSession();
        ...
        else
        {
            return null;
                ...
                public  UserRegistration authenticateUser(UserRegistration ur)
  {
     SessionFactory sf = SessionFactoryGenerator.getSessionFactory();
     Session sess = sf.openSession();
     System.out.println("svvs :"+ur.getUser_id());
   ...
   */
    UserRegistration ur1 = (UserRegistration)sess.get(UserRegistration.class,ur.getUser_id());
    return ur1;
    ...
    public List<Report_Table> getReport()
    {
       ...
       System.out.println(" data after get "+ds);
                 ...
                 public List<Data_Table> getPost(int postid) 
    {
       ...
       Session sess = sf.openSession();
        ...
        else
        {
           ...
           public  AdminLogin authenticateAdmin(AdminLogin ur)
  {
     SessionFactory sf = SessionFactoryGenerator.getSessionFactory();
     Session sess = sf.openSession();
     System.out.println("svvs :"+ur.getAdmin_id());
     
     /*Query q = sess.createQuery("from AdminLogin where admin_id = ? and adminpassword = ?");
     q.setString(0,admin.getAdmin_id());
     q.setString(1,admin.getAdminpassword());
   */
    AdminLogin ur1 = (AdminLogin)sess.get(AdminLogin.class,ur.getAdmin_id());
    return ur1;
